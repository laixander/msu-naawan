    ...
    <section class="container" style="margin: 0 auto; width: 100%; max-width: 1440px;">
        <a-space direction="vertical" size="middle" class="student">
            ...
            <a-card title="List of Students" class="container-cards" :bordered="false" :bodyStyle="display === 'card' ? { padding: '24px' } : { padding: '0' }">
                ...
                <a-space direction="vertical" size="middle" style="width: 100%" v-if="display === 'card'">
                    <a-flex gap="12" wrap="wrap">
                        <a-card hoverable class="student-info" v-for="student in paginatedStudents" :key="student.id" @click="showDrawer(student)">
                            <a-avatar :size="72">
                                <template #icon>
                                    <UserOutlined />
                                </template>
                    ...
                    <a-pagination v-model:current="current" :total="totalStudents" :page-size="pageSize" show-less-items @change="handlePageChange" style="text-align: right;" />
                </a-space>
